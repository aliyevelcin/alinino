...
class Product(models.Model):
    ...
    category = models.ForeignKey("Category",on_delete=models.SET_NULL,related_name='product',db_index=True,null=True,blank=True)
...
class Comment(models.Model):
    ...
    product = models.ForeignKey(Product,related_name='comments',on_delete=models.SET_NULL,null=True,blank=True)
    text = models.TextField()
    date = models.DateTimeField(auto_now_add=True)
